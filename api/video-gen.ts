...
3. Elemento de Imagem (se fornecido pelo usuário ou use imagens ilustrativas):
{
  "type": "image",
...
Gere agora o JSON perfeito para JSON2Video v2.`;
      ...
      // Clean up markdown code block delimiters if the AI ignored system instructions
      ...
      try {
        ...
        // Fallback to a valid minimal structure if Gemini outputs malformed JSON
        jsonPayload = {
          width: 1280,
          height: 720,
          fps: 25,
